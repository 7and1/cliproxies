...
func (h *Handler) RequestGeminiCLIToken(c *gin.Context) {
	...
	conf := &oauth2.Config{
		ClientID:     "", // Set via GEMINI_OAUTH_CLIENT_ID environment variable
		ClientSecret: "", // Set via GEMINI_OAUTH_CLIENT_SECRET environment variable
	...
	go func() {
		...
		ifToken["client_id"] = "" // Set via GEMINI_OAUTH_CLIENT_ID environment variable
		ifToken["client_secret"] = "" // Set via GEMINI_OAUTH_CLIENT_SECRET environment variable
...
func (h *Handler) RequestAntigravityToken(c *gin.Context) {
	const (
		...
		antigravityClientID     = "" // Set via ANTIGRAVITY_OAUTH_CLIENT_ID environment variable
		antigravityClientSecret = "" // Set via ANTIGRAVITY_OAUTH_CLIENT_SECRET environment variable
	)
