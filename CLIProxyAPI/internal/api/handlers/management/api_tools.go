...
const (
	geminiOAuthClientID     = "" // Set via GEMINI_OAUTH_CLIENT_ID environment variable
	geminiOAuthClientSecret = "" // Set via GEMINI_OAUTH_CLIENT_SECRET environment variable
)
...
const (
	antigravityOAuthClientID     = "" // Set via ANTIGRAVITY_OAUTH_CLIENT_ID environment variable
	antigravityOAuthClientSecret = "" // Set via ANTIGRAVITY_OAUTH_CLIENT_SECRET environment variable
)
